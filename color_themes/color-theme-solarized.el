  ...
  (let ((base0T    "#00161c")
    ...
    (color-theme-install
     `(color-theme-solarized
       ...
       ;; font-lock
       (font-lock-builtin-face       ((t (:foreground ,blue))))               ;; green / DarkSlateBlue
       (font-lock-comment-face       ((t (:foreground ,base01   :italic t)))) ;; Dark Cyan
       (font-lock-constant-face      ((t (:foreground ,magenta))))             ;; magenta
       (font-lock-doc-face           ((t (:foreground ,cyan))))               ;; cyan
       (font-lock-function-name-face ((t (:foreground ,violet :background ,base03 ))))             ;; magenta
       (font-lock-keyword-face       ((t (:foreground ,blue   :background ,base03 ))))               ;; blue
       (font-lock-string-face        ((t (:foreground ,darkgreen   :background ,base03 ))))               ;; green
       (font-lock-type-face          ((t (:foreground ,magenta :background ,base03 ))))           ;; DarkSlateBlue
       (font-lock-variable-name-face ((t (:foreground ,cyan))))                ;; red
